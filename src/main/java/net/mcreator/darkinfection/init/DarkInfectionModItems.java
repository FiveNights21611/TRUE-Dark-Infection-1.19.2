...
public class DarkInfectionModItems {
	...
	public static final RegistryObject<Item> QUARTZ_ENRICHED_NETHERITE_ARMOR_HELMET = REGISTRY.register("quartz_enriched_netherite_armor_helmet", () -> new QuartzEnrichedNetheriteArmorItem.Helmet());
	public static final RegistryObject<Item> QUARTZ_ENRICHED_NETHERITE_ARMOR_CHESTPLATE = REGISTRY.register("quartz_enriched_netherite_armor_chestplate", () -> new QuartzEnrichedNetheriteArmorItem.Chestplate());
	public static final RegistryObject<Item> QUARTZ_ENRICHED_NETHERITE_ARMOR_LEGGINGS = REGISTRY.register("quartz_enriched_netherite_armor_leggings", () -> new QuartzEnrichedNetheriteArmorItem.Leggings());
	public static final RegistryObject<Item> QUARTZ_ENRICHED_NETHERITE_ARMOR_BOOTS = REGISTRY.register("quartz_enriched_netherite_armor_boots", () -> new QuartzEnrichedNetheriteArmorItem.Boots());
	public static final RegistryObject<Item> QUARTZ_ENRICHED_NETHERITE = REGISTRY.register("quartz_enriched_netherite", () -> new QuartzEnrichedNetheriteItem());
	...
	public static final RegistryObject<Item> POPPED_ORB_OF_DARKNESS = REGISTRY.register("popped_orb_of_darkness", () -> new PoppedOrbOfDarknessItem());
	...
	public static final RegistryObject<Item> VOIDKINGBOSS_SPAWN_EGG = REGISTRY.register("voidkingboss_spawn_egg",
			() -> new ForgeSpawnEggItem(DarkInfectionModEntities.VOIDKINGBOSS, -3342337, -52, new Item.Properties().tab(DarkInfectionModTabs.TAB_DARKINFECTED)));
	...
	public static final RegistryObject<Item> CHISSELDVOIDSTONEBRICKS = block(DarkInfectionModBlocks.CHISSELDVOIDSTONEBRICKS, DarkInfectionModTabs.TAB_DARKINFECTED);
	...
	public static final RegistryObject<Item> VOID_STONE_COAL_ORE = block(DarkInfectionModBlocks.VOID_STONE_COAL_ORE, DarkInfectionModTabs.TAB_DARKINFECTED);
	public static final RegistryObject<Item> VOID_STONE_IRON_ORE = block(DarkInfectionModBlocks.VOID_STONE_IRON_ORE, DarkInfectionModTabs.TAB_DARKINFECTED);
	public static final RegistryObject<Item> VOID_STONE_REDSTONE_ORE = block(DarkInfectionModBlocks.VOID_STONE_REDSTONE_ORE, DarkInfectionModTabs.TAB_DARKINFECTED);
	public static final RegistryObject<Item> VOID_STONE_LAPIS_ORE = block(DarkInfectionModBlocks.VOID_STONE_LAPIS_ORE, DarkInfectionModTabs.TAB_DARKINFECTED);
	public static final RegistryObject<Item> VOID_STONE_EMERALD_ORE = block(DarkInfectionModBlocks.VOID_STONE_EMERALD_ORE, DarkInfectionModTabs.TAB_DARKINFECTED);
	public static final RegistryObject<Item> VOID_STONE_DIAMOND_ORE = block(DarkInfectionModBlocks.VOID_STONE_DIAMOND_ORE, DarkInfectionModTabs.TAB_DARKINFECTED);
	public static final RegistryObject<Item> VOID_STONE_COPPER_ORE = block(DarkInfectionModBlocks.VOID_STONE_COPPER_ORE, DarkInfectionModTabs.TAB_DARKINFECTED);
	public static final RegistryObject<Item> VOID_STONE_GOLD_ORE = block(DarkInfectionModBlocks.VOID_STONE_GOLD_ORE, DarkInfectionModTabs.TAB_DARKINFECTED);
	public static final RegistryObject<Item> VOID_KING_SPAWNER = block(DarkInfectionModBlocks.VOID_KING_SPAWNER, null);
	public static final RegistryObject<Item> VOID_STONE_BRICK_STAIRS = block(DarkInfectionModBlocks.VOID_STONE_BRICK_STAIRS, DarkInfectionModTabs.TAB_DARKINFECTED);
	public static final RegistryObject<Item> VOID_STONE_BRICK_SLABS = block(DarkInfectionModBlocks.VOID_STONE_BRICK_SLABS, DarkInfectionModTabs.TAB_DARKINFECTED);
	public static final RegistryObject<Item> VOID_STONE_BRICK_WALLS = block(DarkInfectionModBlocks.VOID_STONE_BRICK_WALLS, DarkInfectionModTabs.TAB_DARKINFECTED);
	...
	public static final RegistryObject<Item> VOID_STONE_REDSTONE_ORE_LIT = block(DarkInfectionModBlocks.VOID_STONE_REDSTONE_ORE_LIT, DarkInfectionModTabs.TAB_DARKINFECTED);
