...
public class DarkInfectionModBlocks {
	...
	public static final RegistryObject<Block> CHISSELDVOIDSTONEBRICKS = REGISTRY.register("chisseldvoidstonebricks", () -> new ChisseldvoidstonebricksBlock());
	...
	public static final RegistryObject<Block> VOID_STONE_REDSTONE_ORE = REGISTRY.register("void_stone_redstone_ore", () -> new VoidStoneRedstoneOreBlock());
	...
	public static final RegistryObject<Block> VOID_STONE_EMERALD_ORE = REGISTRY.register("void_stone_emerald_ore", () -> new VoidStoneEmeraldOreBlock());
	public static final RegistryObject<Block> VOID_STONE_DIAMOND_ORE = REGISTRY.register("void_stone_diamond_ore", () -> new VoidStoneDiamondOreBlock());
	...
	public static final RegistryObject<Block> VOID_STONE_BRICK_STAIRS = REGISTRY.register("void_stone_brick_stairs", () -> new VoidStoneBrickStairsBlock());
	public static final RegistryObject<Block> VOID_STONE_BRICK_SLABS = REGISTRY.register("void_stone_brick_slabs", () -> new VoidStoneBrickSlabsBlock());
	public static final RegistryObject<Block> VOID_STONE_BRICK_WALLS = REGISTRY.register("void_stone_brick_walls", () -> new VoidStoneBrickWallsBlock());
	public static final RegistryObject<Block> VOID_STONE_REDSTONE_ORE_LIT = REGISTRY.register("void_stone_redstone_ore_lit", () -> new VoidStoneRedstoneOreLitBlock());
}
