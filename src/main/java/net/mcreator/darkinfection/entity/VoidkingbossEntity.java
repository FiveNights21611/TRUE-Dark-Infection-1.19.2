...
public class VoidkingbossEntity extends Monster implements RangedAttackMob {
	...
	public VoidkingbossEntity(EntityType<VoidkingbossEntity> type, Level world) {
		...
		xpReward = 10000;
		setNoAi(false);
		setCustomName(Component.literal("Void King"));
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new Goal() {
			...
			public boolean canContinueToUse() {
				return VoidkingbossEntity.this.getMoveControl().hasWanted() && VoidkingbossEntity.this.getTarget() != null && VoidkingbossEntity.this.getTarget().isAlive();
			}
		...
		this.goalSelector.addGoal(6, new RandomStrollGoal(this, 0.5, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = VoidkingbossEntity.this.getRandom();
