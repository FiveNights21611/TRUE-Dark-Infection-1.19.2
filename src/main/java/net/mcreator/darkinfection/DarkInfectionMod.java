...
import net.mcreator.darkinfection.init.DarkInfectionModPaintings;
...
public class DarkInfectionMod {
	...
	public DarkInfectionMod() {
		...
		DarkInfectionModBlockEntities.REGISTRY.register(bus);
		DarkInfectionModFeatures.REGISTRY.register(bus);

		DarkInfectionModPaintings.REGISTRY.register(bus);
