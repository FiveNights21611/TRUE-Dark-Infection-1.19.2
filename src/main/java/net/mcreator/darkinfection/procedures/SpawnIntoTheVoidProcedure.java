...
public class SpawnIntoTheVoidProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (world instanceof ServerLevel _origLevel) {
			...
			if (world != null) {
				randomX = Mth.nextInt(RandomSource.create(), -10000, 10000);
				randomZ = Mth.nextInt(RandomSource.create(), -10000, 10000);
				{
					Entity _ent = entity;
					...
					if (_ent instanceof ServerPlayer _serverPlayer)
						_serverPlayer.connection.teleport(randomX, (world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) randomX, (int) randomZ)), randomZ, _ent.getYRot(), _ent.getXRot());
				}
			}
			world = _worldorig;
		}
