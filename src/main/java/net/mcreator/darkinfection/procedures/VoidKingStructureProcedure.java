			...
			if (world instanceof ServerLevel _origLevel) {
				...
				if (world != null) {
					if (world instanceof ServerLevel _serverworld) {
						StructureTemplate template = _serverworld.getStructureManager().getOrCreate(new ResourceLocation("dark_infection", "void_king_spawner"));
						if (template != null) {
					...
					if (entity instanceof Player _player && !_player.level.isClientSide())
						_player.displayClientMessage(Component.literal("You feel a pull towards the middle of this... place."), (false));
